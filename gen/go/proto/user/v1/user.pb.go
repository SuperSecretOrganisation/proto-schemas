...
import (
	...
	v1 "https://github.com/SuperSecretOrganisation/proto-schemas/gen/go/notification_token/v1"
	reflect "reflect"
	sync "sync"
	unsafe "unsafe"
)
...
const file_proto_user_v1_user_proto_rawDesc = "" +
	...
	"\tListUsers\x12\x1f.proto.user.v1.ListUsersRequest\x1a .proto.user.v1.ListUsersResponseBPZNhttps://github.com/SuperSecretOrganisation/proto-schemas/gen/go/user/v1;userpbb\x06proto3"
